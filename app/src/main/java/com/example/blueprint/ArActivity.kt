...
class ArActivity : AppCompatActivity() {
    //information required to perform API calls
    companion object {
        const val APIKey = "AIzaSyCu8ykV8N9VGB2qHOwnsfOJbk8JHHs3qos"
        const val assetURL = "https://poly.googleapis.com/v1/assets"
    }
    //initialize variables needed through out file
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //get keyword string selected in scan activity and pass to API
        val keyword = (this.application as Keyword).keyword

        // perform GET request
        assetURL.httpGet(listOf("key" to APIKey,"keywords" to keyword,"pageSize" to 1)).responseJson { _, _, result ->
            //procces returned JSON
            result.fold({
...
//         Called before processing each frame
    ...
    /**
     * @param model The Uri of our 3D gltf file
     *
